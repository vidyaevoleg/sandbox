var planetGroup, сamera, controls, audio_reader, customUniforms, effectFilm, renderer, scene;
function setup() {
    ...
    function render () {
        ...
        methods.particles.update(scene);
...
var methods = {
    audio : {
        ...
        //     //     methods.particles.cloud.material.opacity = 0.9; // быстрое
        //     // } else {
        //     //     methods.particles.cloud.material.opacity = 0.2; // быстрое
        //     // }
    ...
    particles : {
        ...
        update : function (scene) {
          var audio_data = audio_reader.getData();

          if (audio_data && audio_data.isPlaying) {
            this.cloud.material.opacity = 2 * audio_data.volume;
            this.cloud.material.size = 1 + 3 * audio_data.volume;

            // if (audio_data.isBeat) {
            //   var old_cloud = scene.getObjectByName("particles");
            //   scene.remove(old_cloud);

            //   this.create(scene, {
            //     range: audio_data.volume * 20000,
            //     size: 4 * audio_data.volume,
            //     opacity: 3 * audio_data.volume
            //   });
            // }
